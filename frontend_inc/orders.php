  ...
  <section class="container mt-5 text-xl-center" id="hero" class="hero d-flex align-items-center section-bg">
              ...
              <div class="card-body">
                     ...
                     ?>
                      <tbody>
                        ...
                        foreach($data as $key=> $s_data){
                          ...
                          $total =  $s_data['price'] * $s_data['queantity'];
                          $grantprice = $grantprice + $total;
                          ?>

                            <tr>
                              <td><img style="width: 100px;" src="../upload/food/<?= $s_data['image'] ?>"; alt=""></td> 
                              <td><?= $s_data['name'] ?></td>
                              <td><?= $s_data['queantity'] ?></td>
                              <td>$_<?= $s_data['price'] * $s_data['queantity'] ?>/-</td>
                    ...
                    <tr>
                       ...
                       <td colspan="4">
                       <h3> Total Amount =   $_ <?= $grantprice ?> /-</h3>
                        </td>
                       </div>
                    </tr>
                  ...
                  <?php
                        ...
                        if(!$data){
                            ...
                            ?>
                               <div class="row">
                                <div class="col-md-6">
                                    <a class="btn btn-primary" href="http://localhost/Yummy/#menu">CONTINUE SHOPPING</a>
                                </div>
                               <div class="col-md-6">
                                    <span style="text-align:center; color:red;"><h3>YOU HAVE NOT ANY ORDER</h3></span>
                                </div>
                               </div>
                            <?php
                        }
