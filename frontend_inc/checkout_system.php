...
?>
  ...
  <!-- ======= Hero Section ======= -->
  <section class="container mt-5" id="hero" class="hero d-flex align-items-center section-bg">

               <h1 style="text-align: center;">CHECKOUT SYSTEM</h1>
                <div class="card mt-5">
              <div class="card-body">

              <form action="../Controller/order.php" enctype="multipart/form-data" method="POST">
                   ...
                   <div class="row">
                        ...
                        <button style="background-color: red; width:100%; color:white; border-radius:5px; border:none; padding:5px; margin-top:17px;" name="submit">Submit</button>
