          ...
          <div class="container-fluid" data-aos="fade-up">
            ...
            <div class="slides-3 swiper" data-aos="fade-up" data-aos-delay="100">
              ...
              foreach($data as $sdata){
                ...
                <div class="swiper-slide event-item d-flex flex-column justify-content-end" style="background-image: url(./upload/event/<?= $sdata['image'] ?>)">
                <h3><?= $sdata['title'] ?></h3>
                <div class="price align-self-start"><?=  $sdata['price'] ?></div>
                <p class="description">
                  <?= $sdata['description'] ?>
                </p>
              </div><!-- End Event item -->
